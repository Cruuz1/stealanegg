...
print = function(...)
    if _G.Cruuzz_EnablePrint then
        oldPrint(...)
    end
end

print("🔵 Loading Cruuzz HUB...")

-- ==================================================
-- CACHE SYSTEM
-- ==================================================
_G.Cruuzz_Cache = _G.Cruuzz_Cache or {}

local function GetScript(path)
    local fullPath = BASE_URL .. path
    if _G.Cruuzz_Cache[fullPath] then
        return _G.Cruuzz_Cache[fullPath]
    end
    local script = game:HttpGet(fullPath)
    _G.Cruuzz_Cache[fullPath] = script
    return script
end
...
-- ==================================================
Loading.Update(92)
if _G.Cruuzz_TabsManager then
    _G.Cruuzz_TabsManager:SelectTabByName("Info")
end
