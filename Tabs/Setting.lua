...
local SelectedMethod = _G.Cruuzz_SelectedMethod or "TeleportFly"
...
local function CreateOption(Name, Order)
    ...
    Option.MouseButton1Click:Connect(function()
        ...
        _G.Cruuzz_SelectedMethod = Name

        if _G.Cruuzz_ConfigSystem then
            _G.Cruuzz_ConfigSystem.Save()
        end

        print("[Cruuzz] Method Teleport Selected: " .. Name)
    end)
...
if _G.Cruuzz_SelectedMethod == nil then
    _G.Cruuzz_SelectedMethod = "TeleportFly"
end
...
local InitialSpeed = _G.Cruuzz_TeleportSpeed or 300
...
SpeedTextBox.FocusLost:Connect(function()
    ...
    if Value then
        ...
        _G.Cruuzz_TeleportSpeed = Value

        if _G.Cruuzz_TeleportSystem then
            _G.Cruuzz_TeleportSystem.SetSpeed(Value)
        end
        ...
        print("[Cruuzz] Teleport Speed: " .. tostring(Value))
    else
        SpeedTextBox.Text = "300"
        _G.Cruuzz_TeleportSpeed = 300

        if _G.Cruuzz_TeleportSystem then
            _G.Cruuzz_TeleportSystem.SetSpeed(300)
        end
...
if _G.Cruuzz_TeleportSpeed == nil then
    _G.Cruuzz_TeleportSpeed = 300
end
...
local function ToggleWalkSpeed()
    ...
    if WalkSpeedEnabled then
        ...
        if _G.Cruuzz_WalkSpeed then
            _G.Cruuzz_WalkSpeed.SetValue(WalkSpeedValue)
            _G.Cruuzz_WalkSpeed.Enable()
        end
    else
        WalkSpeedCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        WalkSpeedStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Cruuzz_WalkSpeed then
            _G.Cruuzz_WalkSpeed.Disable()
        end
    end
end
...
WalkSpeedTextBox.FocusLost:Connect(function()
    ...
    if val then
        ...
        if WalkSpeedEnabled and _G.Cruuzz_WalkSpeed then
            _G.Cruuzz_WalkSpeed.SetValue(WalkSpeedValue)
        end
    else
        WalkSpeedTextBox.Text = tostring(WalkSpeedValue)
...
local function ToggleAntiTrap()
    ...
    if AntiTrapEnabled then
        ...
        if _G.Cruuzz_AntiTrap then
            _G.Cruuzz_AntiTrap.Enable()
        end
    else
        AntiTrapCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiTrapStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Cruuzz_AntiTrap then
            _G.Cruuzz_AntiTrap.Disable()
        end
    end
end
...
GodModeButton.MouseButton1Click:Connect(function()
    if _G.Cruuzz_GodMode then
        _G.Cruuzz_GodMode.Enable()
    end
...
FastClickButton.MouseButton1Click:Connect(function()
    if not _G.Cruuzz_ManualFastClick then
        warn("[Cruuzz] ManualFastClick feature not loaded")
        ShowNotification("Manual Fast Click Not Loaded")
        return
    end

    if _G.Cruuzz_ManualFastClick.IsEnabled() then
        _G.Cruuzz_ManualFastClick.Disable()
        ShowNotification("Manual Fast Click Stop")
    else
        _G.Cruuzz_ManualFastClick.Enable()
...
task.spawn(function()
    task.wait(0.5)
    if _G.Cruuzz_ManualFastClick then
        if _G.Cruuzz_ManualFastClick.IsEnabled() then
...
local function ToggleAntiAFK()
    ...
    if AntiAFKEnabled then
        ...
        if _G.Cruuzz_AntiAFK then
            _G.Cruuzz_AntiAFK.Enable()
        end
    else
        AntiAFKCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiAFKStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Cruuzz_AntiAFK then
            _G.Cruuzz_AntiAFK.Disable()
        end
    end
end
...
task.spawn(function()
    ...
    -- ✅ Sync Dropdown
    if _G.Cruuzz_SelectedMethod then
        SelectedMethod = _G.Cruuzz_SelectedMethod
        DropdownBtn.Text = SelectedMethod .. " ▼"
    end

    -- ✅ Sync Speed
    if _G.Cruuzz_TeleportSpeed then
        SpeedTextBox.Text = tostring(_G.Cruuzz_TeleportSpeed)
    end

    -- ✅ Sync Anti AFK
    if _G.Cruuzz_AntiAFK then
        if _G.Cruuzz_AntiAFK.IsEnabled() then
            AntiAFKEnabled = true
