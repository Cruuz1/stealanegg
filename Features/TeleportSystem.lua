-- ==================================================
-- Cruuzz HUB - TELEPORT SYSTEM (DUAL MODE + DUAL OPTION)
-- ==================================================
...
if not CollectEvent then
    warn("[Cruuzz] CollectEvent not found")
    return
end

print("[Cruuzz] TeleportSystem: CollectEvent OK")
...
local function EnableRagdollBypass()
    ...
    print("[Cruuzz] Ragdoll Bypass: ON")
end
...
local function DisableRagdollBypass()
    ...
    print("[Cruuzz] Ragdoll Bypass: OFF")
end
...
local function TeleportToTarget(TargetPos, Callback)
    if CurrentMethod == "InstantTeleport" then
        print("[Cruuzz] Instant TP to Target")
        InstantFlyTP(TargetPos, Callback)
    else
        print("[Cruuzz] FlyTP to Target (Shot TP)")
...
local function FireForestStrike()
    ...
    print("[Cruuzz] ForestStrike Fired")
end
...
local function AutoStop()
    ...
    print("[Cruuzz] TeleportSystem: Auto Stop")
end
...
local function FlyToSafeZone()
    ...
    print("[Cruuzz] FlyTP to Safe Zone")
...
local function StartProcess()
    ...
    print("[Cruuzz] FlyTP to First Egg (Shot TP)")
...
local function FullReset()
    ...
    print("[Cruuzz] TeleportSystem: Full Reset")
end
...
local function Enable()
    ...
    if not CollectEvent then warn("[Cruuzz] CollectEvent not found") return end
    if not TARGET_UID then warn("[Cruuzz] No Target ID") return end

    FullReset()
    StartProcess()

    print("[Cruuzz] TeleportSystem: ON | Method: " .. CurrentMethod)
end

local function Disable()
    FullReset()
    print("[Cruuzz] TeleportSystem: OFF")
end

local function SetTargetId(Id)
    TARGET_UID = Id
    print("[Cruuzz] TeleportSystem Target ID: " .. tostring(Id))
end
...
local function SetSpeed(Value)
    ...
    FLY_SPEED = Value
    RETURN_SPEED = Value
    print("[Cruuzz] TeleportSystem Speed: " .. tostring(Value))
end
...
local function SetMethod(Method)
    ...
    print("[Cruuzz] TeleportSystem Method: " .. CurrentMethod)
end
