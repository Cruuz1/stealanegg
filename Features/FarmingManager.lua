-- ==================================================
-- Cruuzz HUB | FEATURE | Farming Manager (NEW)
-- ==================================================
...
local function StopAll()
    if _G.Cruuzz_AFKSystem and _G.Cruuzz_AFKSystem.IsEnabled() then
        local TreadmillPos = _G.Cruuzz_AFKSystem.GetMyTreadmillPos()
    ...
    if _G.Cruuzz_VIPTP and _G.Cruuzz_VIPTP.IsEnabled() then
        _G.Cruuzz_VIPTP.Disable()
        print("[FarmingManager] ✅ VIPTP Stopped")
    end

    if _G.Cruuzz_TeleportSystem and _G.Cruuzz_TeleportSystem.IsEnabled() then
...
local function StartVIPTP(EggUid)
    ...
    _G.Cruuzz_VIPTP.SetTargetId(EggUid)
    _G.Cruuzz_VIPTP.Enable()
end
...
local function Enable()
    ...
    print("[Cruuzz] FarmingManager: ON")
end
...
local function Disable()
    ...
    print("[Cruuzz] FarmingManager: OFF")
end
