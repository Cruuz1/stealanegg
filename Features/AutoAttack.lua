-- ==================================================
-- Cruuzz HUB | FEATURE | Auto Attack
...
local function EnableAutoEquip()
    ...
    EquipBat()
    print("[Cruuzz] Auto Equip Bat: ON")
end
...
local function DisableAutoEquip()
    ...
    print("[Cruuzz] Auto Equip Bat: OFF")
end
...
local function EnableAutoHit()
    ...
    print("[Cruuzz] Auto Fire Remote (Range 17 + Fast): ON")
end
...
local function DisableAutoHit()
    ...
    print("[Cruuzz] Auto Fire Remote: OFF")
end
