...
local function EnableAntiAFK()
    ...
    MouseThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            DoMouseMove()
            print("[Cruuzz] Anti AFK: Mouse Move")
        end
    end)
    ...
    CameraThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            if not AntiAFKEnabled then break end
            DoCameraRotation()
            print("[Cruuzz] Anti AFK: Camera Rotation")
        end
    end)
    ...
    ZoomThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            if not AntiAFKEnabled then break end
            DoCameraZoom()
            print("[Cruuzz] Anti AFK: Camera Zoom")
        end
    end)

    print("[Cruuzz] Anti AFK: ON (3 Methods)")
end
