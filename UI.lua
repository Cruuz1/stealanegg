...
-- Clean old instances
pcall(function()
    local Old = GuiParent:FindFirstChild("Cruuzz_HUB")
...
-- ==================================================
_G.Cruuzz_Main = Main
_G.Cruuzz_TopBar = TopBar
_G.Cruuzz_Sidebar = Sidebar
_G.Cruuzz_TabScroll = TabScroll
_G.Cruuzz_Content = Content
_G.Cruuzz_ScreenGui = ScreenGui
_G.Cruuzz_Toggle = Toggle
_G.Cruuzz_GuiParent = GuiParent
